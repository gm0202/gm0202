...
I'm a **Software Engineer** from 🇮🇳 India who loves solving real-world problems with elegant tech solutions.

💼 **Open to**: Collaborations • Internships • Jobs  
📫 **Reach me**:  
[![GitHub](https://img.shields.io/badge/GitHub-gm0202-181717?logo=github)](https://github.com/gm0202)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Gaurang%20Mishra-blue?logo=linkedin)](https://linkedin.com/in/gaurang-mishra-952069278)

---

### 🔐 Featured Project: SecureHer

**SecureHer** is a smart safety app for women, integrating real-time emergency tools:
- SOS Alert
- Live Location Streaming
- Safe Route Navigation
- Hidden Camera Detector
- Disguised Panic Tools
- Personal Safety and Self Defence Resources

🔗 [View on GitHub](https://github.com/gm0202/SecureHer)
...
- **Frameworks**: Flutter, OpenCV, Streamlit, Windows Forms  
- **Tools**: Git, GitHub, Firebase, MySQL, GCP Console  
- **Platforms**: Windows, Kali Linux, SQL Server Studio  
- **Skills**: Agile Dev, Team Collaboration, CLI, Docs
